...
$query = mysqli_query($koneksi,"select * from absensi a JOIN karyawan k ON k.nip = a.nip JOIN jabatan j ON j.id_jabatan = k.id_jabatan WHERE id_absensi = $_GET[id]")or die(mysqli_error());
