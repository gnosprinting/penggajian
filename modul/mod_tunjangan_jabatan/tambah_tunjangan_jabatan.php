        ...
        <div class="field-group">
            ...
            <div class="field">
                <select name="nip" id="nip" class="validate[required]">
                    <?php
                    $tampil = mysqli_query($koneksi,"SELECT * FROM karyawan ORDER BY nama_karyawan");
                    if ($r['nip'] == 0) {
        ...
        <div class="field-group">
            ...
            <div class="field">
                <select name="id_jenis_tunjangan" id="id_jenis_tunjangan" class="validate[required]">
                    <?php
                    $tampil2 = mysqli_query($koneksi,"SELECT * FROM jenis_tunjangan ORDER BY nama_jenis_tunjangan");
                    if ($r['id_jenis_tunjangan'] == 0) {
                        echo "<option value='' selected>- Pilih Jenis Tunjangan -</option>";
                    }

                    while ($w2 = mysqli_fetch_array($tampil2)) {
