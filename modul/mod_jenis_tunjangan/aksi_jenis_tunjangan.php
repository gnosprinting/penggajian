...
if (empty($_SESSION['id_pengguna']) AND empty($_SESSION['passuser'])) {
    ...
    if ($module == 'jenis_tunjangan' AND $act == 'tambah') {
        ...
        $cek = mysqli_query($koneksi,"SELECT nama_jenis_tunjangan FROM jenis_tunjangan WHERE nama_jenis_tunjangan = '$jenis_tunjangan'");
        if (mysqli_num_rows($cek) > 0) {
            ...
            $query = mysqli_query($koneksi,"INSERT INTO jenis_tunjangan(nama_jenis_tunjangan)
        ...
        $query = mysqli_query($koneksi,"UPDATE jenis_tunjangan SET nama_jenis_tunjangan = '$_POST[nama_jenis_tunjangan]'
        ...
        $query = mysqli_query($koneksi,"DELETE FROM jenis_tunjangan WHERE id_jenis_tunjangan='$_GET[id]'");
